...
export type NotificationType = 'report_published' | 'newsletter_published' | 'event_created' | 'sponsorship_assigned' | 'invitation_accepted' | 'registration_approved' | 'system';
